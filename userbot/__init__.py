...
UPSTREAM_REPO_URL = (os.environ.get("UPSTREAM_REPO_URL")
                     or "https://github.com/Alpha-is-here/Doraemon.git")
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("I'm [Doraemon](https://github.com/Alpha-is-here/Doraemon.git) modules helper...\nplease make your own bot, don't use mine 😋")
            else:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@Doraemon"):
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "GitHub Repo",
                                "https://github.com/Alpha-is-here/Doraemon.git"),
                            custom.Button.url(
                                "Support",
                                "https://t.me/Doraemon_support")],
                    ],
                    link_preview=False,
                )
